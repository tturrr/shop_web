...
/* 검색 끝 */
	...
	$sql = 'SELECT count(*) as cnt from women_board' . $searchSql;
...
<?php
    ...
    $prevPage = (($currentSection - 1) * $oneSection); //이전 페이지, 11~20일 때 이전을 누르면 10 페이지로 이동.
    	...
    	if($page != 1) {
    		...
    		$paging .= '<li style="float:left" class="page page_start"><a href="./womens_shop.php?page=1' . $subString . '">처음</a></li>';
    	}
     ...
     $paging .= '<li style="float:left" class="page page_prev"><a href="./womens_shop.php?page=' . $prevPage . $subString . '">이전</a></li>';
    	...
    	for($i = $firstPage; $i <= $lastPage; $i++) {
    		...
    		$paging .= '<li style="float:left" class="page"><a href="./womens_shop.php?page=' . $i . $subString . '">' . $i . '</a></li>';
    	...
    	$paging .= '<li  style="float:left" class="page page_next"><a href="./womens_shop.php?page=' . $nextPage . $subString . '">다음</a></li>';
    	}
        ...
        $paging .= '<li style="float:left" class="page page_end"><a href="./womens_shop.php?page=' . $allPage . $subString . '">끝</a></li>';
 ...
 <script type="text/javascript">
  function mySubmit(index) {
    if (index == 1) {
      document.myForm.action='womens_details_modify.php';
    }
    if (index == 2) {
	...
	<header id="header"><!--header-->
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
                ...
                <form action="./womens_shop.php" method="get">
			...
			<div class="row">
				...
				<div class='col-sm-9 padding-right'>
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">womens items</h2>
          </div>
         ...
         <div class="col-sm-4">
              ...
              <div class="single-products">
                  <div class="productinfo text-center">
                   <form ACTION = "womens_details.php" >
               ...
               $currentLimit = ($onePage * $page) - $onePage; //몇 번째의 글부터 가져오는지
     	         ...
     	         $sql = 'SELECT * from women_board' . $searchSql . ' order by b_no desc' . $sqlLimit; //원하는 개수만큼 가져온다. (0번째부터 20번째까지
